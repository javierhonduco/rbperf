...
fn dump_ruby_structs_ruby_3_1_3() {
    let vm_offset: i32 = offset_of!(
    ...
    File::create("src/ruby_versions/ruby_3_1_3.yaml")
        .unwrap()
        .write_all(yaml.as_bytes())
        .unwrap();
}

fn dump_ruby_structs_ruby_3_2_0() {
    let vm_offset: i32 = offset_of!(
    ...
    File::create("src/ruby_versions/ruby_3_2_0.yaml")
        .unwrap()
        .write_all(yaml.as_bytes())
        .unwrap();
}

fn dump_ruby_structs_ruby_3_2_1() {
    let vm_offset: i32 = offset_of!(
    ...
    File::create("src/ruby_versions/ruby_3_2_1.yaml")
        .unwrap()
        .write_all(yaml.as_bytes())
        .unwrap();
}
